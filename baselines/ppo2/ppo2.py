    ...
    def run(self):
        ...
        if curiosity:
            ...
            for t in reversed(range(self.nsteps)):
                ...
                print("type of equation {} {} {} {} ".format( type(delta) ,type(self.gamma) , type(self.lam) , type(lastgaelam)))
                print("No dimension of equation {} {} {} {}".format(np.shape(delta) , np.shape(self.gamma)  , np.shape(self.lam) , np.shape(lastgaelam) ))
                print("Values of all {} {} {} {} ".format(delta ,self.gamma , self.lam , lastgaelam ))
